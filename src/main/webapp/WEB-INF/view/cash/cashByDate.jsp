...
<body>
	...
	<table border="1">
		...
		<tr>
			...
			<td>${c.updatedate}</td>
			<td>
				<a href="${pageContext.request.contextPath}/cash/updateCashForm.jsp?cashNo=${c.cashNo}">수정</a>
			</td>
			<td>
				<a href="${pageContext.request.contextPath}/cash/deleteCash.jsp?cashNo=${c.cashNo}&cashDate=${c.cashDate}">삭제</a>
			</td>
		</tr>		
		</c:forEach>
